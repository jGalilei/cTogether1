...
// node_modules/@uiw/codemirror-extensions-hyper-link/esm/index.js
...
var HyperLinkIcon = class extends WidgetType {
  constructor(state) {
    super();
    this.state = void 0;
    this.state = state;
...
function hyperLinkExtension(_temp) {
  var {
    regexp,
    match,
    handle,
...
//# sourceMappingURL=@uiw_codemirror-extensions-hyper-link.js.map
